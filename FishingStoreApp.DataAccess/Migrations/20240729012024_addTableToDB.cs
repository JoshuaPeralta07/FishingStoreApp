...
namespace FishingStoreApp.DataAccess.Migrations
{
    ...
    public partial class addTableToDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Description", "ImageUrl", "Price", "ProductCode", "ProductName", "Stocks" },
                values: new object[,]
                {
                    { 1, 1, "A true all-around performer with the features and feel associated with rods four times the cost.", "", 369.99000000000001, "ECHOCBXL690", "Echo Carbon XL Medium/Fast Fly Rod", 10 },
                    { 2, 1, "Despite the deceptively airy feel, the Abu Garcia Veritas 4.0 Spinning Surf Rod is robust, responsive and comfortable to fish with from dusk to dawn.", "", 229.99000000000001, "1547516", "Abu Garcia Veritas 2 Piece Surf Rod", 10 },
                    { 3, 2, "A good reliable braid makes the difference between an average fishing trip and an exceptional one. We have proved just how reliable this top quality braid is and thoroughly recommend it. The strongest, most abrasion resistant superline in its class.", "", 239.99000000000001, "119730-V", "Berkley Fireline Original Bulk 1300m Braid", 5 }
                });
