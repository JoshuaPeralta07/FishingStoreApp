...
namespace FishingStoreApp.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            List<Product> objProductList = _unitOfWork.Product.GetAll(includProps:"Category").ToList();
        ...
        public IActionResult Delete(int? id)
        {
            ...
            var oldImgPath = Path.Combine(wwwRootPath, productToBeDeleted.ImageUrl.TrimStart('\\'));
